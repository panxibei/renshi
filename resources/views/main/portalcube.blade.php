...
<cube-form :model="model" @validate="validateHandler" @submit="submitHandler" @reset="resetHandler">
  <cube-form-group>
    <cube-form-item :field="fields[0]">
        <cube-input v-model.lazy="jiaban_add_uid" placeholder="" readonly></cube-input>
    </cube-form-item>
    <cube-form-item :field="fields[1]">
        <cube-input v-model.lazy="jiaban_add_applicant" placeholder="" readonly></cube-input>
    </cube-form-item>
    <cube-form-item :field="fields[2]">
        <cube-input v-model.lazy="jiaban_add_department" placeholder="" readonly></cube-input>
    </cube-form-item>
  </cube-form-group>
  <cube-form-group>
  <br>
